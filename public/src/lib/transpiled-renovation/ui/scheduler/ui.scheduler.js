...
var Scheduler = /*#__PURE__*/function (_Widget) {
    ...
    switch (args.name) {
      ...
      case 'currentView':
        ...
        this._postponeResourceLoading().done(function (resources) {
          ...
          (_this2$_header = _this2._header) === null || _this2$_header === void 0 ? void 0 : _this2$_header.option(_this2._headerConfig());
  ...
  _proto._renderWorkSpace = function _renderWorkSpace(groups) {
    ...
    countConfig.startDate && ((_this$_header5 = this._header) === null || _this$_header5 === void 0 ? void 0 : _this$_header5.option('currentDate', this._workSpace._getHeaderDate()));
  ...
  _proto.getStartViewDate = function getStartViewDate() {
    ...
    return (_this$_workSpace = this._workSpace) === null || _this$_workSpace === void 0 ? void 0 : _this$_workSpace.getStartViewDate();
  };
