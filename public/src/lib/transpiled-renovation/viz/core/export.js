...
exports.plugin = exports.getMarkup = exports.exportWidgets = exports.exportFromMarkup = exports.combineMarkups = exports.ExportMenu = exports.DEBUG_set_combineMarkups = exports.DEBUG_set_ExportMenu = void 0;

var _extend = require("../../core/utils/extend");

var _window2 = require("../../core/utils/window");
...
function setPrint(imageSrc, options) {
  return function () {
    ...
    var widthRatio = calculatePrintPageWidth(window.document.body) / options.width; ///#DEBUG
    ...
    var removeFrame = function removeFrame() {
      ...
      ///#DEBUG
      options.__test && options.__test.checkAssertions(); ///#ENDDEBUG

      _this.parentElement.removeChild(_this); ///#DEBUG


      options.__test && options.__test.deferred.resolve(origImageSrc, (_window = window) === null || _window === void 0 ? void 0 : (_window$document = _window.document) === null || _window$document === void 0 ? void 0 : (_window$document$body = _window$document.body) === null || _window$document$body === void 0 ? void 0 : _window$document$body.style); ///#ENDDEBUG
    };
...
var plugin = {
  ...
  members: {
    ...
    print: function print() {
      ...
      var menu = this._exportMenu;
      var options = getExportOptions(this, this._getOption('export') || {}); ///#DEBUG

      options.__test = this._getOption('export').__test; ///#ENDDEBUG
...
var DEBUG_set_combineMarkups = function DEBUG_set_combineMarkups(value) {
  exports.combineMarkups = combineMarkups = value;
};

exports.DEBUG_set_combineMarkups = DEBUG_set_combineMarkups;

var DEBUG_set_ExportMenu = function DEBUG_set_ExportMenu(value) {
  exports.ExportMenu = ExportMenu = value;
}; ///#ENDDEBUG


exports.DEBUG_set_ExportMenu = DEBUG_set_ExportMenu;