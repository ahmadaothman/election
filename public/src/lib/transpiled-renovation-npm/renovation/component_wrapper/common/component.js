    ...
    get: function get() {
      ...
      if (!this._elementAttr) {
        ...
        var attrs = Array.from(attributes).filter(function (attr) {
          ...
          return !_this8._propsInfo.templates.includes(attr.name) && ((_attributes$attr$name = attributes[attr.name]) === null || _attributes$attr$name === void 0 ? void 0 : _attributes$attr$name.specified);
