...
import { createTimeZoneCalculator } from '../../renovation/ui/scheduler/timeZoneCalculator/createTimeZoneCalculator'; // STYLE scheduler
    ...
    switch (args.name) {
      ...
      case 'currentView':
        ...
        this._postponeResourceLoading().done(resources => {
          ...
          (_this$_header5 = this._header) === null || _this$_header5 === void 0 ? void 0 : _this$_header5.option(this._headerConfig());
  ...
  _appointmentsConfig() {
    var config = {
      ...
      onContentReady: () => {
        ...
        (_this$_workSpace3 = this._workSpace) === null || _this$_workSpace3 === void 0 ? void 0 : _this$_workSpace3.option('allDayExpanded', this._isAllDayExpanded());
      }
    };
    return config;
  }
