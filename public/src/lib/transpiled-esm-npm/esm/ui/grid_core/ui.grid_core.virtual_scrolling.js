  ...
  return {
    init: function init() {
      ...
      dataController.pageChanged.add(pageIndex => {
        this.scrollToPage(pageIndex !== null && pageIndex !== void 0 ? pageIndex : dataController.pageIndex());
      });
        ...
        var members = {
          ...
          _loadDataSource: function _loadDataSource() {
            if (this._rowsScrollController && isVirtualPaging(this)) {
              ...
              var {
                loadPageCount
              } = (_this$getLoadPagePara = this.getLoadPageParams()) !== null && _this$getLoadPagePara !== void 0 ? _this$getLoadPagePara : {};
          ...
          initVirtualRows: function initVirtualRows() {
            ...
            if (!this._rowsScrollController) {
              ...
              this._rowsScrollController.positionChanged.add(() => {
                ...
                (_this$_dataSource2 = this._dataSource) === null || _this$_dataSource2 === void 0 ? void 0 : _this$_dataSource2.setViewportItemIndex(this._rowsScrollController.getViewportItemIndex());
              });
            }
          ...
          getLoadPageParams: function getLoadPageParams(byLoadedPage) {
            ...
            var lastLoadOptions = (_this$_dataSource3 = this._dataSource) === null || _this$_dataSource3 === void 0 ? void 0 : _this$_dataSource3.lastLoadOptions();
            ...
            var totalCountCorrection = ((_this$_dataSource4 = this._dataSource) === null || _this$_dataSource4 === void 0 ? void 0 : _this$_dataSource4.totalCountCorrection()) || 0;
