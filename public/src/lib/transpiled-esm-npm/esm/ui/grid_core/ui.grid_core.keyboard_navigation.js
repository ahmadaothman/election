...
var KeyboardNavigationController = core.ViewController.inherit({
  ...
  _upDownKeysHandler: function _upDownKeysHandler(eventArgs, isEditing) {
    ...
    var isRowEditingInCurrentRow = (_this$_editingControl = this._editingController) === null || _this$_editingControl === void 0 ? void 0 : _this$_editingControl.isEditRow(visibleRowIndex);
