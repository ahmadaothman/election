        ...
        if (dataSource) {
          if (value !== undefined) {
            ...
            if (oldValue !== value) {
              ...
              return dataSource[optionName === 'pageIndex' ? 'load' : 'reload']().done(() => that.pageChanged.fire(pageIndex));
            }
      ...
      var members = {
        ...
        updateItems: function updateItems(change, isDataChanged) {
          ...
          if (that._repaintChangesOnly !== undefined) {
            ...
            change.repaintChangesOnly = (_change$repaintChange = change.repaintChangesOnly) !== null && _change$repaintChange !== void 0 ? _change$repaintChange : that._repaintChangesOnly;
